...
public class CategoryController {
    ...
    {
        Object[] categories = categoryService.getCategories();
    ...
    {
        Object[] cat_prod = categoryService.getCategoryByProductId(product_id);
    ...
    {
        Object[] cat_dept = categoryService.getCategoryByDepartmentId(department_id);
